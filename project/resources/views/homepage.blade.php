<x-layout>
    ...
    <header id="homepage" class="container px-5 py-5 d-flex flex-column h-100 bg-black text-light">
        <div class="row gx-5 align-items-center justify-content-center">
            ...
            <div class="col-12 col-md-6 dx">
                <div class="text-container text-center dx-content">
                    <div class="badge bg-gradient-primary-to-secondary text-dark mb-1">
                        <p class="text-uppercase bg-light p-1">Design · Development · Marketing</p>
                    </div>
                    ...
                    <div class="d-grid gap-3 d-sm-flex justify-content-sm-center justify-content-md-center mb-3">
                        <a class="btn btn-primary btn-lg px-5 py-3 me-sm-3 fs-6 fw-bolder ha"
                            href="{{ route('about') }}">Resume</a>
                ...
                <div id="carouselExample" class="carousel slide" data-bs-ride="carousel">
                    <div class="carousel-inner">
                        <div class="carousel-item active">
                            <img src="{{ asset('img/ex1.webp') }}"
                                class="d-block w-75 mx-auto img-thumbnail" alt="Immagine 1">
                        </div>
                        <div class="carousel-item">
                            <img src="{{ asset('img/ex2.webp') }}"
                                class="d-block w-75 mx-auto img-thumbnail" alt="Immagine 2">
                        </div>
                        <div class="carousel-item">
                            <img src="{{ asset('img/ex3.webp') }}"
                                class="d-block w-75 mx-auto img-thumbnail" alt="Immagine 3">
                        </div>
                    </div>
                    ...
                    <div class="col-xxl-8">
                        <div class="text-center my-5">
                            ...
                            <p class="text-muted">Check my profile and find the most suitable service for you. Contact
                                me for a custom need or specific information. In my portfolio, you will find examples
                                and
